...
CORPUS = 'data/parsed_corpora/Italian/SUD_IT_ISDT.csv'
SEED = 100
OUTPUT_FILE = 'data/surprisal/SUD/Italian/SUD_IT_ISDT_logp.csv'
OUTPUT_FILE_TEST = 'data/surprisal/SUD/Italian/SUD_IT_ISDT_logp_test.csv'
