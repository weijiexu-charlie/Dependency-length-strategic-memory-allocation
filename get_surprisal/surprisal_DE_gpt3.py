...
CORPUS = 'data/parsed_corpora/German/SUD_DE_GSD.csv'
SEED = 100
OUTPUT_FILE = 'data/surprisal/SUD/German/SUD_DE_GSD_logp.csv'
OUTPUT_FILE_TEST = 'data/surprisal/SUD/German/SUD_DE_GSD_logp_test.csv'
