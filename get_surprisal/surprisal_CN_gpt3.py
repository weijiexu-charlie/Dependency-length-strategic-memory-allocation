...
CORPUS = 'data/parsed_corpora/Chinese/SUD_CN_GSDSimp.csv'
SEED = 100
OUTPUT_FILE = 'data/surprisal/SUD/Chinese/SUD_CN_GSDSimp_logp.csv'
OUTPUT_FILE_TEST = 'data/surprisal/SUD/Chinese/SUD_CN_GSDSimp_logp_test.csv'
