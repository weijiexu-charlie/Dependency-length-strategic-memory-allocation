...
CORPUS = 'data/parsed_corpora/Japanese/SUD_JA_GSD.csv'
SEED = 100
OUTPUT_FILE = 'data/surprisal/SUD/Japanese/SUD_JA_GSD_logp.csv'
OUTPUT_FILE_TEST = 'data/surprisal/SUD/Japanese/SUD_JA_GSD_logp_test.csv'
