...
CORPUS = 'data/parsed_corpora/Amharic/SUD_AM_ATT.csv'
SEED = 100
OUTPUT_FILE = 'data/surprisal/SUD/Amharic/SUD_AM_ATT_logp.csv'
OUTPUT_FILE_TEST = 'data/surprisal/SUD/Amharic/SUD_AM_ATT_logp_test.csv'
OUTPUT_FILE_SMALL = 'data/surprisal/SUD/Amharic/SUD_AM_ATT_logp_small.csv'


pd.set_option('mode.chained_assignment', None)


def get_doc_dfs(corpus, max_wnum=200, min_wnum=50):
	'''
