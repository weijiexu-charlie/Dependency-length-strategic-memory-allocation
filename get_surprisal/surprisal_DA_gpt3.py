...
CORPUS = 'data/parsed_corpora/Danish/SUD_DA_DDT.csv'
SEED = 100
OUTPUT_FILE = 'data/surprisal/SUD/Danish/SUD_DA_DDT_logp.csv'
OUTPUT_FILE_TEST = 'data/surprisal/SUD/Danish/SUD_DA_DDT_logp_test.csv'
